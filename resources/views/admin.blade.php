                                            ...
                                            <div class="panel-body">
                                                <form class="for-horizontal"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            <label for="price_per_hour" class="col-md-2 control-label">Price per hour</label>
                                                            <div class="col-md-10">
                                                    ...
                                                    <input type="number" min="0" name="min_hour"
                                                           value="{{ $tarif->min_hour }}">
                                                    <input type="number" min="0" name="price_minimum"
                                                           value="{{ $tarif->price_minimum }}">
                                                    <input type="number" min="0" name="price_per_person"
                                                           value="{{ $tarif->price_per_person }}">
                                                    <input type="number" min="0" name="discard"
                                                           value="{{ $tarif->discard }}">
